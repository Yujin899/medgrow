                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            <TextEffect
                                ...
                                Grow Your Clinic Without Hiring a Full Team
                            </TextEffect>
                            <TextEffect
                                per="line"
                                preset="fade-in-blur"
                                ...
                                MedGrow combines tech, content, design, and marketing into clear monthly plans that deliver one thing: growth for your medical or dental clinic.
                            </TextEffect>
                                    ...
                                    <div className="bg-background has-[input:focus]:ring-muted relative grid grid-cols-[1fr_auto] items-center rounded-[calc(var(--radius)+0.5rem)] border pr-2 shadow shadow-zinc-950/5 has-[input:focus]:ring-2">
                                        ...
                                        <div className="md:pr-1.5 lg:pr-0">
                                            <Button
                                                ...
                                                suppressHydrationWarning>
                                                <span className="hidden md:block">Get Your Growth Plan</span>
                                                <SendHorizonal
